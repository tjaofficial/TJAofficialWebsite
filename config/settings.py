...
STRIPE_WEBHOOK_SECRET_TICKETS = os.getenv("STRIPE_WEBHOOK_SECRET_TICKETS", "")
STRIPE_WEBHOOK_SECRET_SHOP = os.getenv("STRIPE_WEBHOOK_SECRET_SHOP", "")
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "aackerman@voxoluniverse.com")
